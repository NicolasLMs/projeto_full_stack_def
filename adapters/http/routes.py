def configure_routes(app, usuario_controller, produto_controller):
    ...
    app.add_url_rule('/atualizar_usuario', view_func=usuario_controller.atualizar_usuario, methods=['PUT'])
    app.add_url_rule('/buscar_por_email_usuario/<string: email>', view_func=usuario_controller.buscar_por_email, methods=['GET'])
